  ...
  return (
    <>
      ...
      <div className={s.text}>
        ...
        <ul>
          <Typography as={'li'}>
            <Typography as={'strong'}>Account</Typography> means a unique account created for You to access our Service or
            parts of our Service.
          </Typography>
          <Typography as={'li'}>
            <Typography as={'strong'}>Affiliate</Typography> means an entity that controls, is controlled by or is under
          ...
          <Typography as={'li'}>
            <Typography as={'strong'}>Company</Typography> (referred to as either &quot;the Company&quot;, &quot;We&quot;,
            &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to JWU Media Inc, 63-36 110
            street Forest Hills 11375 NY.
          </Typography>
          <Typography as={'li'}>
            <Typography as={'strong'}>Cookies</Typography> are small files that are placed on Your computer, mobile device
          ...
          <Typography as={'li'}>
            <Typography as={'strong'}>Device</Typography> means any device that can access the Service such as a computer, a
          ...
          <Typography as={'li'}>
            <Typography as={'strong'}>Service Provider</Typography> means any natural or legal person who processes the data
          ...
          <Typography as={'li'}>
            <Typography as={'strong'}>Usage Data</Typography> refers to data collected automatically, either generated by
          ...
          <Typography as={'li'}>
            <Typography as={'strong'}>You</Typography> means the individual accessing or using the Service, or the company,
      ...
      <div className={s.text}>
        ...
        <ul>
          ...
          <Typography as={'li'}>
            <Typography as={'strong'}>Web Beacons.</Typography> Certain sections of our Service and our emails may contain
        ...
        <ul>
          <Typography as={'li'}>
            <Typography>
              <Typography as={'strong'}>To provide and maintain our Service</Typography>, including to monitor the usage of
              our Service.
            </Typography>
          </Typography>
          <Typography as={'li'}>
            <Typography>
              <Typography as={'strong'}>To manage Your Account:</Typography> to manage Your registration as a user of the
          ...
          <Typography as={'li'}>
            <Typography>
              <Typography as={'strong'}>For the performance of a contract:</Typography> the development, compliance and
          ...
          <Typography as={'li'}>
            <Typography>
              <Typography as={'strong'}>To contact You:</Typography> To contact You by email, telephone calls, SMS, or other
          ...
          <Typography as={'li'}>
            <Typography>
              <Typography as={'strong'}>To provide You</Typography> with news, special offers and general information about
          ...
          <Typography as={'li'}>
            <Typography>
              <Typography as={'strong'}>To manage Your requests:</Typography> To attend and manage Your requests to Us.
            </Typography>
          </Typography>
          <Typography as={'li'}>
            <Typography>
              <Typography as={'strong'}>For business transfers:</Typography> We may use Your information to evaluate or
          ...
          <Typography as={'li'}>
            <Typography>
              <Typography as={'strong'}>For other purposes</Typography>: We may use Your information for other purposes,
        ...
        <ul>
          ...
          <Typography as={'li'}>
            <Typography as={'strong'}>With Affiliates:</Typography> We may share Your information with Our affiliates, in
          ...
          <Typography as={'li'}>
            <Typography as={'strong'}>With business partners:</Typography> We may share Your information with Our business
          ...
          <Typography as={'li'}>
            <Typography as={'strong'}>With Your consent</Typography>: We may disclose Your personal information for any
