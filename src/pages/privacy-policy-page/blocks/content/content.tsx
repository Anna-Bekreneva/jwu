    ...
    <div className={s.container}>
      ...
      <div className={s.block} id={'interpretation'}>
        ...
        <div className={s.text}>
          ...
          <ul className={s.list}>
            <Typography as={'li'}>
              <Typography as={'strong'}>Account</Typography> means a unique account created for You to access our
              Service or
              parts of our Service.
            </Typography>
            <Typography as={'li'}>
              <Typography as={'strong'}>Affiliate</Typography> means an entity that controls, is controlled by or is
              under
            ...
            <Typography as={'li'}>
              ...
              Company&quot;, &quot;We&quot;,
              &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to JWU Media Inc, 63-36 110
              street Forest Hills 11375 NY.
            </Typography>
            <Typography as={'li'}>
              <Typography as={'strong'}>Cookies</Typography> are small files that are placed on Your computer, mobile
              device
            ...
            <Typography as={'li'}>
              <Typography as={'strong'}>Device</Typography> means any device that can access the Service such as a
              computer, a
              cellphone or a digital tablet.
            </Typography>
            <Typography as={'li'}>
              <Typography as={'strong'}>Personal Data</Typography> is any information that relates to an identified or
            ...
            <Typography as={'li'}>
              <Typography as={'strong'}>Usage Data</Typography> refers to data collected automatically, either generated
              by
            ...
            <Typography as={'li'}>
              <Typography as={'strong'}>You</Typography> means the individual accessing or using the Service, or the
              company,
      ...
      <div className={s.block} id={'collecting'}>
        ...
        <div className={s.text}>
          ...
          <ul className={s.list}>
            <Typography as={'li'}>
              <Typography as={'strong'}>Cookies or Browser Cookies.</Typography> A cookie is a small file placed on Your
            ...
            <Typography as={'li'}>
              <Typography as={'strong'}>Web Beacons.</Typography> Certain sections of our Service and our emails may
              contain
          ...
          <ul className={s.list}>
            <Typography className={s.noMargin} as={'li'}>
        ...
        <div className={s.text}>
          ...
          <ul className={s.list}>
            <Typography as={'li'}>
              <Typography>
                <Typography as={'strong'}>To provide and maintain our Service</Typography>, including to monitor the
                usage of
                our Service.
              </Typography>
            </Typography>
            <Typography as={'li'}>
              <Typography>
                <Typography as={'strong'}>To manage Your Account:</Typography> to manage Your registration as a user of
                the
            ...
            <Typography as={'li'}>
              <Typography>
                <Typography as={'strong'}>For the performance of a contract:</Typography> the development, compliance
                and
            ...
            <Typography as={'li'}>
              <Typography>
                <Typography as={'strong'}>To contact You:</Typography> To contact You by email, telephone calls, SMS, or
                other
            ...
            <Typography as={'li'}>
              <Typography>
                <Typography as={'strong'}>To provide You</Typography> with news, special offers and general information
                about
            ...
            <Typography as={'li'}>
              <Typography>
                <Typography as={'strong'}>To manage Your requests:</Typography> To attend and manage Your requests to
                Us.
              </Typography>
            </Typography>
            <Typography as={'li'}>
              <Typography>
                <Typography as={'strong'}>For business transfers:</Typography> We may use Your information to evaluate
                or
            ...
            <Typography as={'li'}>
              <Typography>
                <Typography as={'strong'}>For other purposes</Typography>: We may use Your information for other
                purposes,
          ...
          <ul className={s.list}>
            <Typography as={'li'}>
              <Typography as={'strong'}>With Service Providers:</Typography> We may share Your personal information with
              Service Providers to monitor and analyze the use of our Service, to contact You.
            </Typography>
            <Typography as={'li'}>
              <Typography as={'strong'}>For business transfers:</Typography> We may share or transfer Your personal
            ...
            <Typography as={'li'}>
              <Typography as={'strong'}>With Affiliates:</Typography> We may share Your information with Our affiliates,
              in
            ...
            <Typography as={'li'}>
              <Typography as={'strong'}>With business partners:</Typography> We may share Your information with Our
              business
              partners to offer You certain products, services or promotions.
            </Typography>
            <Typography as={'li'}>
              <Typography as={'strong'}>With other users:</Typography> when You share personal information or otherwise
            ...
            <Typography as={'li'}>
              <Typography as={'strong'}>With Your consent</Typography>: We may disclose Your personal information for
              any
        ...
        <div className={s.text}>
          <Typography as={'h3'} variant={TypographyVariant.subtitle}>Retention of Your Personal Data</Typography>
          <Typography>
        ...
        <div className={s.text}>
          <Typography as={'h3'} variant={TypographyVariant.subtitle}>Transfer of Your Personal Data</Typography>
          <Typography>
        ...
        <div className={s.text}>
          <Typography as={'h3'} variant={TypographyVariant.subtitle}>Delete Your Personal Data</Typography>
          <Typography>
        ...
        <div className={s.text}>
          <Typography as={'h3'} variant={TypographyVariant.subtitle}>Disclosure of Your Personal Data</Typography>
          <Typography as={'h4'} variant={TypographyVariant.strong1}>Business Transactions</Typography>
          <Typography>
            If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be
            transferred. We will provide notice before Your Personal Data is transferred and becomes
            subject to a different Privacy Policy.
          </Typography>
          <Typography as={'h4'} variant={TypographyVariant.strong1}>Law enforcement</Typography>
          <Typography>
            Under certain circumstances, the Company may be required to disclose Your Personal Data if
            required to do so by law or in response to valid requests by public authorities (e.g. a
            court or a government agency).
          </Typography>
          <Typography as={'h4'} variant={TypographyVariant.strong1}>Other legal requirements</Typography>
          <Typography>
          ...
          <ul className={s.list}>
            ...
            <Typography as={'li'}>Protect and defend the rights or property of the Company</Typography>
            <Typography as={'li'}>Prevent or investigate possible wrongdoing in connection with the Service</Typography>
            <Typography as={'li'}>Protect the personal safety of Users of the Service or the public</Typography>
            <Typography as={'li'}>Protect against legal liability</Typography>
          </ul>
        </div>

        <div className={s.text}>
          <Typography as={'h3'} variant={TypographyVariant.subtitle}>Security of Your Personal Data</Typography>
          <Typography>
